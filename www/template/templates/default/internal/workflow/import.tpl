...
<table width="770" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		...
		<td class="internal" align="center">
			<br><br>
			<form action='importStep1.php' method="post">
			<table border="0" align="center">
				...
				<tr>
					<td class="internal">Scegli il workflow da importare:</td>
					<td><select name="idWorkflowImported" class="textform">
						{$option1}
						</select>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="right"><br><input type="submit" value="Invia" class="pulsanti"></td>
				</tr>
			</table>
			</form>
		</td>
